 ...
 * 1) Set a break point in PonyCodegenGenerator.java in the postProcessOperationsWithModels() method.
...
public class DebugCodegenLauncher 
{
  ...
  public void launchCodeGeneratorInDebugMode()
  {
    ...
    // this allows you to easily set break points in PonyCodegenGenerator.
    String commandLineParams =
        ...
        "-t ./src/main/resources/pony-codegen "+          // template directory
        "-o out/pony-codegen "+                           // output directory
        "-g pony-codegen ";                               // use this codegen library
